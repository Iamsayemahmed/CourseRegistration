...
public class MyAdapterPriority extends RecyclerView.Adapter<com.example.courceregistration.MyAdapterPriority.MyViewHolder>{
        ...
        @NonNull
        @Override
        public com.example.courceregistration.MyAdapterPriority.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View v = LayoutInflater.from(context).inflate(R.layout.item_contact,parent,false);
            return new com.example.courceregistration.MyAdapterPriority.MyViewHolder(v);
        }

        @Override
        public void onBindViewHolder(@NonNull com.example.courceregistration.MyAdapterPriority.MyViewHolder holder, int position) {
